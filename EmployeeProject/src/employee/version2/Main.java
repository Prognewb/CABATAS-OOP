...
public class Main {
    public static void main(String[] args) {
        ...
        HourlyEmlpoyee employee3 = new HourlyEmlpoyee(100, "Jan", date2, date1, 50, 500);
        ...
        CommissionEmployee employee8 = new CommissionEmployee("Dane", 10000);
        CommissionEmployee employee9 = new CommissionEmployee(400, "Antonie", date2, date1, 100000);
